...
describe("PurchaseOrderItem", () => {
  ...
  test("POST /purchase-order-items", async () => {
  ...
  test("GET /purchase-order-items", async () => {
    await request(app.getHttpServer())
  ...
  test("GET /purchase-order-items/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/purchase-order-items"}/${nonExistingId}`)
      .expect(404)
      .expect({
        statusCode: 404,
  ...
  test("GET /purchase-order-items/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/purchase-order-items"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
