...
export class ProductControllerBase {
  ...
  @common.Get("/:id/purchaseOrderItems")
  @nestAccessControl.UseRoles({
    resource: "Product",
    action: "read",
    possession: "any",
  ...
  async findManyPurchaseOrderItems(
    @common.Req() request: Request,
    @common.Param() params: ProductWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
    ...
    const results = await this.service.findPurchaseOrderItems(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/purchaseOrderItems")
  @nestAccessControl.UseRoles({
    resource: "Product",
    action: "update",
    possession: "any",
  ...
  @common.Patch("/:id/purchaseOrderItems")
  @nestAccessControl.UseRoles({
    resource: "Product",
    action: "update",
    possession: "any",
  ...
  @common.Delete("/:id/purchaseOrderItems")
  @nestAccessControl.UseRoles({
    resource: "Product",
    action: "update",
    possession: "any",
